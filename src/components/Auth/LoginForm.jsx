...
<h2 className='text-center text-[rgba(38, 38, 38, 1)] text-5xl font-semibold'>Login</h2>
<p className='text-center font-normal mb-8 text-lg text-[rgba(76, 76, 77, 1)] mt-2'>Welcome back! Please log in to access your account.</p>
...
<div className='mb-4'>
    ...
    <label htmlFor='terms' className='text-[#59595A] text-lg ml-2'>Remember me</label>
</div>
<button className='h-[63px] bg-[#FF9500] w-full rounded-xl text-white'>Login</button>
...
<div className='w-full flex justify-center items-center mt-10'>
    <span className='text-[#262626] text-lg text-center'>Don't have an account? <span className='underline font-medium'>
