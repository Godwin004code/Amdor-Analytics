...
import heroImg from "../../assets/ABOUT US PAGE PICTURE.jpeg"
...
const AboutHero = () => {
  ...
  return (
    ...
    <div className='my-auto w-[58%]  sm:w-full'>
        <div className='flex'>
...
Beyond earning a certificate, our learners gain the confidence and expertise to succeed in the competitive tech job market. Let Amdor Analytics be your partner in unlocking your potential and achieving success in the world of technology.</p>
        <div className='flex gap-10 sm:my-7 mt-5 my-3'>
            <button onClick={() => setShowText(!showText)} className='h-[60px] w-full text-base rounded-md text-white bg-[#3AA619]'>Mission</button>
            <button onClick={() => setShowText(!showText)} className='h-[60px] w-full text-base rounded-md text-black bg-[#E8E8E880]'> Vision</button>
        </div>
        <div className='bg-[#EDEDED] w-full h-[1px]' />
        {showText === false ? <p  className='text-[##666C89] font-light text-base sm:mt-6 mt-3'>Our mission is to bridge the skills gap by equipping learners with in-demand skills, enabling them to make informed decisions, drive innovation, and create positive change in a tech-driven world, particularly across the African continent.</p> :   <p  className='text-[##666C89] font-light text-base sm:mt-6 mt-8'>Our vision is to be the catalyst for a tech-driven revolution, where individuals are empowered to effectively harness technology and data. We aspire to shape a future where tech skills and insights are accessible to all, fueling innovation and unlocking endless possibilities across industries. We strive to be a trusted platform that not only imparts knowledge but also fosters a supportive community of learners, mentors, and industry professionals, propelling individuals toward successful careers and lifelong learning in all areas of technology.</p>}
